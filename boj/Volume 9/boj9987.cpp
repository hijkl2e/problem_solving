...
int main() {
	...
	vector<string> A{
		...
		"Noivern", "Xerneas", "Yveltal", "Zygarde"
	};
	vector<string> B{
		...
		"Normal Flying", "Normal Flying", "Poison", "Poison", "Electric",
		"Electric", "Ground", "Ground", "Poison", "Poison",
		...
		"Bug Grass", "Bug Grass", "Bug Poison", "Bug Poison", "Ground",
		"Ground", "Normal", "Normal", "Water", "Water",
		"Fighting", "Fighting", "Fire", "Fire", "Water",
		"Water", "Water Fighting", "Psychic", "Psychic", "Psychic",
		"Fighting", "Fighting", "Fighting", "Grass Poison", "Grass Poison",
		"Grass Poison", "Water Poison", "Water Poison", "Rock Ground", "Rock Ground",
		"Rock Ground", "Fire", "Fire", "Water Psychic", "Water Psychic",
		"Electric Steel", "Electric Steel", "Normal Flying", "Normal Flying", "Normal Flying",
		"Water", "Water Ice", "Poison", "Poison", "Water",
		"Water Ice", "Ghost Poison", "Ghost Poison", "Ghost Poison", "Rock Ground",
		"Psychic", "Psychic", "Water", "Water", "Electric",
		"Electric", "Grass Psychic", "Grass Psychic", "Ground", "Ground",
		"Fighting", "Fighting", "Normal", "Poison", "Poison",
		"Ground Rock", "Ground Rock", "Normal", "Grass", "Normal",
		"Water", "Water", "Water", "Water", "Water",
		"Water Psychic", "Psychic Fairy", "Bug Flying", "Ice Psychic", "Electric",
		"Fire", "Bug", "Normal", "Water", "Water Flying",
		"Water Ice", "Normal", "Normal", "Water", "Electric",
		"Fire", "Normal", "Rock Water", "Rock Water", "Rock Water",
		"Rock Water", "Rock Flying", "Normal", "Ice Flying", "Electric Flying",
		"Fire Flying", "Dragon", "Dragon", "Dragon Flying", "Psychic",
		"Psychic", "Grass", "Grass", "Grass", "Fire",
		"Fire", "Fire", "Water", "Water", "Water",
		"Normal", "Normal", "Normal Flying", "Normal Flying", "Bug Flying",
		"Bug Flying", "Bug Poison", "Bug Poison", "Poison Flying", "Water Electric",
		"Water Electric", "Electric", "Fairy", "Normal Fairy", "Fairy",
		"Fairy Flying", "Psychic Flying", "Psychic Flying", "Electric", "Electric",
		"Electric", "Grass", "Water Fairy", "Water Fairy", "Rock",
		"Water", "Grass Flying", "Grass Flying", "Grass Flying", "Normal",
		"Grass", "Grass", "Bug Flying", "Water Ground", "Water Ground",
		"Psychic", "Dark", "Dark Flying", "Water Psychic", "Ghost",
		"Psychic", "Psychic", "Normal Psychic", "Bug", "Bug Steel",
		"Normal", "Ground Flying", "Steel Ground", "Fairy", "Fairy",
		"Water Poison", "Bug Steel", "Bug Rock", "Bug Fighting", "Dark Ice",
		"Normal", "Normal", "Fire", "Fire Rock", "Ice Ground",
		"Ice Ground", "Water Rock", "Water", "Water", "Ice Flying",
		"Water Flying", "Steel Flying", "Dark Fire", "Dark Fire", "Water Dragon",
		"Ground", "Ground", "Normal", "Normal", "Normal",
		"Fighting", "Fighting", "Ice Psychic", "Electric", "Fire",
		"Normal", "Normal", "Electric", "Fire", "Water",
		"Rock Ground", "Rock Ground", "Rock Dark", "Psychic Flying", "Fire Flying",
		"Psychic Grass", "Grass", "Grass", "Grass", "Fire",
		"Fire Fighting", "Fire Fighting", "Water", "Water Ground", "Water Ground",
		"Dark", "Dark", "Normal", "Normal", "Bug",
		"Bug", "Bug Flying", "Bug", "Bug Poison", "Water Grass",
		"Water Grass", "Water Grass", "Grass", "Grass Dark", "Grass Dark",
		"Normal Flying", "Normal Flying", "Water Flying", "Water Flying", "Psychic Fairy",
		"Psychic Fairy", "Psychic Fairy", "Bug Water", "Bug Flying", "Grass",
		"Grass Fighting", "Normal", "Normal", "Normal", "Bug Ground",
		"Bug Flying", "Bug Ghost", "Normal", "Normal", "Normal",
		"Fighting", "Fighting", "Normal Fairy", "Rock", "Normal",
		"Normal", "Dark Ghost", "Steel Fairy", "Steel Rock", "Steel Rock",
		"Steel Rock", "Fighting Psychic", "Fighting Psychic", "Electric", "Electric",
		"Electric", "Electric", "Bug", "Bug", "Grass Poison",
		"Poison", "Poison", "Water Dark", "Water Dark", "Water",
		"Water", "Fire Ground", "Fire Ground", "Fire", "Psychic",
		"Psychic", "Normal", "Ground", "Ground Dragon", "Ground Dragon",
		"Grass", "Grass Dark", "Normal Flying", "Dragon Flying", "Normal",
		"Poison", "Rock Psychic", "Rock Psychic", "Water Ground", "Water Ground",
		"Water", "Water Dark", "Ground Psychic", "Ground Psychic", "Rock Grass",
		"Rock Grass", "Rock Bug", "Rock Bug", "Water", "Water",
		"Normal", "Normal", "Ghost", "Ghost", "Ghost",
		"Ghost", "Grass Flying", "Psychic", "Dark", "Psychic",
		"Ice", "Ice", "Ice Water", "Ice Water", "Ice Water",
		"Water", "Water", "Water", "Water Rock", "Water",
		"Dragon", "Dragon", "Dragon Flying", "Steel Psychic", "Steel Psychic",
		"Steel Psychic", "Rock", "Ice", "Steel", "Dragon Psychic",
		"Dragon Psychic", "Water", "Ground", "Dragon Flying", "Steel Psychic",
		"Psychic", "Grass", "Grass", "Grass Ground", "Fire",
		"Fire Fighting", "Fire Fighting", "Water", "Water", "Water Steel",
		"Normal Flying", "Normal Flying", "Normal Flying", "Normal", "Normal Water",
		"Bug", "Bug", "Electric", "Electric", "Electric",
		"Grass Poison", "Grass Poison", "Rock", "Rock", "Rock Steel",
		"Rock Steel", "Bug", "Bug Grass", "Bug Flying", "Bug Flying",
		"Bug Flying", "Electric", "Water", "Water", "Grass",
		"Grass", "Water", "Water Ground", "Normal", "Ghost Flying",
		"Ghost Flying", "Normal", "Normal", "Ghost", "Dark Flying",
		"Normal", "Normal", "Psychic", "Poison Dark", "Poison Dark",
		"Steel Psychic", "Steel Psychic", "Rock", "Psychic Fairy", "Normal",
		"Normal Flying", "Ghost Dark", "Dragon Ground", "Dragon Ground", "Dragon Ground",
		"Normal", "Fighting", "Fighting Steel", "Ground", "Ground",
		"Poison Bug", "Poison Dark", "Poison Fighting", "Poison Fighting", "Grass",
		"Water", "Water", "Water Flying", "Grass Ice", "Grass Ice",
		"Dark Ice", "Electric Steel", "Normal", "Ground Rock", "Grass",
		"Electric", "Fire", "Fairy Flying", "Bug Flying", "Grass",
		"Ice", "Ground Flying", "Ice Ground", "Normal", "Psychic Fighting",
		"Rock Steel", "Ghost", "Ice Ghost", "Electric Ghost", "Psychic",
		"Psychic", "Psychic", "Steel Dragon", "Water Dragon", "Fire Steel",
		"Normal", "Ghost Dragon", "Psychic", "Water", "Water",
		"Dark", "Grass", "Normal", "Psychic Fire", "Grass",
		"Grass", "Grass", "Fire", "Fire Fighting", "Fire Fighting",
		"Water", "Water", "Water", "Normal", "Normal",
		"Normal", "Normal", "Normal", "Dark", "Dark",
		"Grass", "Grass", "Fire", "Fire", "Water",
		"Water", "Psychic", "Psychic", "Normal Flying", "Normal Flying",
		"Normal Flying", "Electric", "Electric", "Rock", "Rock",
		"Rock", "Psychic Flying", "Psychic Flying", "Ground", "Ground Steel",
		"Normal", "Fighting", "Fighting", "Fighting", "Water",
		"Water Ground", "Water Ground", "Fighting", "Fighting", "Bug Grass",
		"Bug Grass", "Bug Grass", "Bug Poison", "Bug Poison", "Bug Poison",
		"Grass Fairy", "Grass Fairy", "Grass", "Grass", "Water",
		"Ground Dark", "Ground Dark", "Ground Dark", "Fire", "Fire",
		"Grass", "Bug Rock", "Bug Rock", "Dark Fighting", "Dark Fighting",
		"Psychic Flying", "Ghost", "Ghost", "Water Rock", "Water Rock",
		"Rock Flying", "Rock Flying", "Poison", "Poison", "Dark",
		"Dark", "Normal", "Normal", "Psychic", "Psychic",
		"Psychic", "Psychic", "Psychic", "Psychic", "Water Flying",
		"Water Flying", "Ice", "Ice", "Ice", "Normal Grass",
		"Normal Grass", "Electric Flying", "Bug", "Bug Steel", "Grass Poison",
		"Grass Poison", "Water Ghost", "Water Ghost", "Water", "Bug Electric",
		"Bug Electric", "Grass Steel", "Grass Steel", "Steel", "Steel",
		"Steel", "Electric", "Electric", "Electric", "Psychic",
		"Psychic", "Ghost Fire", "Ghost Fire", "Ghost Fire", "Dragon",
		"Dragon", "Dragon", "Ice", "Ice", "Ice",
		"Bug", "Bug", "Electric Ground", "Fighting", "Fighting",
		"Dragon", "Ground Ghost", "Ground Ghost", "Dark Steel", "Dark Steel",
		"Normal", "Normal Flying", "Normal Flying", "Dark Flying", "Dark Flying",
		"Fire", "Bug Steel", "Dark Dragon", "Dark Dragon", "Dark Dragon",
		"Bug Fire", "Bug Fire", "Steel Fighting", "Rock Fighting", "Grass Fighting",
		"Flying", "Electric Flying", "Dragon Fire", "Dragon Electric", "Ground Flying",
		"Dragon Ice", "Water Fighting", "Normal Psychic", "Bug Steel", "Grass",
		...
		"Fairy", "Grass", "Grass", "Fighting", "Fighting Dark",
		"Normal", "Psychic", "Psychic", "Steel Ghost", "Steel Ghost",
		"Steel Ghost", "Fairy", "Fairy", "Fairy", "Fairy",
		"Dark Psychic", "Dark Psychic", "Rock Water", "Rock Water", "Poison Water",
		"Poison Dragon", "Water", "Water", "Electric Normal", "Electric Normal",
		"Rock Dragon", "Rock Dragon", "Rock Ice", "Rock Ice", "Fairy",
		"Fighting Flying", "Electric Fairy", "Rock Fairy", "Dragon", "Dragon",
		"Dragon", "Steel Fairy", "Ghost Grass", "Ghost Grass", "Ghost Grass",
		"Ghost Grass", "Ice", "Ice", "Flying Dragon", "Flying Dragon",
		"Fairy", "Dark Flying", "Dragon Ground"
	};
	int N{};
	cin >> N;
	cout << A[N] << "\n" << B[N] << "\n";
